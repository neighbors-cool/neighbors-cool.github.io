  ...
  (this.workbox.routing = (function (t, e) {
    ...
    class o {
      ...
      handleRequest({ request: t, event: e }) {
        ...
        const { params: r, route: n } = this.findMatchingRoute({ url: s, request: t, event: e });
        let o,
          i = n && n.handler;
        if ((!i && this.s && (i = this.s), i)) {
          ...
          return o instanceof Promise && this.o && (o = o.catch((r) => this.o.handle({ url: s, request: t, event: e }))), o;
        }
      }
      findMatchingRoute({ url: t, request: e, event: s }) {
        ...
        for (const n of r) {
          ...
          if (o) return (r = o), ((Array.isArray(o) && 0 === o.length) || (o.constructor === Object && 0 === Object.keys(o).length) || 'boolean' == typeof o) && (r = void 0), { route: n, params: r };
        }
        return {};
      }
      setDefaultHandler(t) {
