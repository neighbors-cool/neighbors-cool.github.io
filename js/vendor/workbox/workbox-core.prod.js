  ...
  (this.workbox.core = (function (e) {
    ...
    const c = (e) => new URL(String(e), location.href).href.replace(new RegExp(`^${location.origin}`), ''),
      ...
      l = async ({ request: e, mode: t, plugins: n = [] }) => {
        ...
        let r = e;
        for (const e of s) (r = await e.cacheKeyWillBeUsed.call(e, { mode: t, request: r })), 'string' == typeof r && (r = new Request(r));
        return r;
      },
    ...
    class g {
      ...
      async getAllKeys(e, t, n) {
        return (await this.getAllMatching(e, { query: t, count: n, includeKeys: !0 })).map((e) => e.key);
      }
      async getAllMatching(e, { index: t, query: n = null, direction: s = 'next', count: r, includeKeys: i = !1 } = {}) {
    ...
    const m = {
      fetch: async ({ request: e, fetchOptions: t, event: s, plugins: r = [] }) => {
        ...
        try {
          ...
          for (const e of r) 'fetchDidSucceed' in e && (n = await e.fetchDidSucceed.call(e, { event: s, request: a, response: n }));
          return n;
        } catch (e) {
          for (const t of i)
    ...
    var v = Object.freeze({
      ...
      resultingClientExists: async function (e) {
        ...
        for (; performance.now() - r < 2e3 && ((t = await self.clients.matchAll({ type: 'window' })), (s = t.find((t) => (e ? t.id === e : !n.has(t.id)))), !s); ) await q(100);
        return s;
      },
      timeout: q,
      WorkboxError: n,
